...
abstract class Avram::Model
  ...
  macro association(table_name, type, relationship_type, foreign_key = nil, through = nil, query = nil)
    {% ASSOCIATIONS << {type: type, table_name: table_name.id, foreign_key: foreign_key, relationship_type: relationship_type, through: through, query: query} %}
  end
end
