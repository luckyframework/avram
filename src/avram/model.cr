...
class Avram::Model
  ...
  macro setup(table_name, primary_key_type)
    ...
    setup_save_operation({{table_name}}, {{primary_key_type}})
    setup_table_name({{table_name}})
    setup_column_names_method
    add_schema_enforcer_methods_for({{table_name}}, {{ COLUMNS }})
  end
  ...
  macro setup_base_query_class(table_name)
    Avram::BaseQueryTemplate.setup({{ @type }}, {{ COLUMNS }}, {{ ASSOCIATIONS }}, {{ table_name }})
  end

  macro setup_save_operation(table_name, primary_key_type)
    Avram::SaveOperationTemplate.setup({{ @type }}, {{ COLUMNS }}, {{ table_name }}, {{ primary_key_type }})
  end
  ...
  macro setup_column_names_method
